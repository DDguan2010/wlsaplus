...
Push a tag such as `v1.0.0` to run `.github/workflows/release.yml`. It builds the PWA archive, Android APK, Windows installer, and macOS DMG/ZIP, then attaches them to a GitHub Release.
