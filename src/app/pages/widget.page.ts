      ...
      <section class="content">
        @if (type() === 'todo') {
          ...
          @for (todo of store.todos(); track todo.id) {
            <div class="todo" [class.expanded]="expandedTodoId() === todo.id" [attr.data-task-color]="todo.color">
