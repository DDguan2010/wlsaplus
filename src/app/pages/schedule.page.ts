...
@Component({
  ...
  styles: `
    ...
    .matrix-scroll { width: 100%; overflow: auto; } .week-matrix { min-width: 1120px; display: grid; grid-template-columns: 76px repeat(5, minmax(200px, 1fr)); grid-template-rows: 62px auto; }
