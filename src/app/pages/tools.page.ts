  ...
  template: `
    <div class="page">
      ...
      <section class="tool-list" aria-label="Available tools">
        ...
        <a class="tool-row surface" routerLink="/tools/map"><span class="tool-icon material-symbols-rounded">map</span><span><strong>Map</strong><small>Find school buildings and classrooms on the WLSA campus map.</small></span><span class="arrow material-symbols-rounded">chevron_right</span></a>
      </section>
    </div>
  `,
  styles: `
